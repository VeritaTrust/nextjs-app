        ...
        <div className="offcanvas-body">
          ...
          <div className="offcanvas-body">
            <ul className="social-Connect">
              <li>
                <button title="Connect with Facebook">
              ...
              <li>
                <button title="Connect with MetaMask">
                  <i className="flaticon-fox" id="metaloginbtn"></i>
                </button>
              </li>
              <li>
            ...
            <button type="submit" className="btn btn-success" id="userbutton">
              Login
            </button>
            ...
            <a
              ...
              href="https://dev.veritatrust.com/resetpassword"
            >
