        ...
        <div className="row mt-3">
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb mb-0 mb-md-3">
              ...
              <li className="breadcrumb-item"><Link href="/Categories">Category 1</Link></li>
              <li className="breadcrumb-item active" aria-current="page">Current page</li>
            </ol>
          </nav>
        </div>
        <div className="row d-flex align-items-center mb-3 aos animated aos-init aos-animate" data-aos="fade-up"
          ...
          <div className="col-lg-8 pt-2 pb-5 d-grid info-mark">
            <div className="logo my-1">
              <img
                ...
                alt="dell-npos-auto-sn-esg-5y-keep-your-hd-for-enterprise" width="200" height="200"/>
            </div>
            <div className="brand">

              <h1>{productName}</h1>
              <small className="text-muted"><strong>6</strong> reviews • Good</small>
              <div className="form__header__note">
                ...
                <Link href="/listings/write-review/dell-npos-auto-sn-esg-5y-keep-your-hd-for-enterprise"
                      className="bg-success text-white d-inline py-2 px-3 rounded-3 shadow">Write a review</Link>
                <Link href="/ask_question" className="bg-primary text-white d-inline py-2 px-3 rounded-3 shadow">Ask a
                  question</Link>
              </div>
            </div>
          </div>
