...
const categorylistClass = [
  ...
  "flaticon flaticon-beauty-saloon me-3",
  "flaticon flaticon-responsive me-3",
  "flaticon flaticon-creativity me-3",
  "flaticon flaticon-suitcase me-3",
  "flaticon flaticon-baby-products me-3",
  "flaticon flaticon-prototype me-3",
  "flaticon flaticon-office-supplies me-3",
        ...
        <div className="container py-5">
          <div className="row mb-4">
            <div className="col-lg-8">
              <h4 className="display-6 text-white">Discover the different categories</h4>
            </div>
            <div className="col-lg-4 text-end">
              <a href="/categories" className="btn btn-primary mt-3">All categories</a>
            </div>
          </div>
          <ul className="row text-white category">
            {categorylist.map((categoryname, index) => (
              <li key={index} className="col-md-6 col-lg-3 mb-4 "><a className="p-3 bg-white text-primary rounded-5"
                                                                     href="#"><i
                className={categoryname[1]}></i> {categoryname[0]}</a></li>
            ))}
          </ul>
        </div>
      </section>
