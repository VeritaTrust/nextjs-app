...
function StateProfile({data}: Props) {
  ...
  const isBasicInfo = () => {
    return data.isBasicInfo ? ["complete", "pending d-none"] : ["complete d-none", "pending"];
  }

  const isKYC = () => {
    return data.isKyc ? ["complete", "pending d-none"] : ["complete d-none", "pending"];
  }

  const isMetamask = () => {
    return data.isMetamask ? ["complete", "pending d-none"] : ["complete d-none", "pending"];
  }
