  ...
  return (
    <>
      <nav className="navbar sticky-top navbar-white bg-white navbar-dark navbar-expand-lg shadow-sm">
        <div className="container" id="container-menu"><Link className="navbar-brand" href="/">
          <img src={'logo.png'} alt="Veritatrust" width="170"/>
        </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <form className="d-flex w-lg-50 search my-3 my-lg-0" role="search" action="/search">
              <input className="form-control" placeholder="search product or service" name="query"/>
            </form>

            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-auto">
              <li className="nav-item dropdown">

                <Link href="/Explore" className="nav-link dropdown-toggle active align-self-center"
                      aria-current="page"> Explore</Link>
                ...
                <ul className="submenu dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a className="dropdown-item" href="#"><i className="flaticon flaticon-user"></i> Another
                    action</a></li>
                  <li>
              ...
              <li className="nav-item">
                <Link href="/Create" className="nav-link  align-self-center" aria-current="page"> Create</Link>

              </li>
              <li className="nav-item"><a className="nav-link align-self-center" type="button"
                                          data-bs-toggle="offcanvas" data-bs-target="#account" aria-controls="account"
                                          onClick={() => setActive(!isActive)}><i
