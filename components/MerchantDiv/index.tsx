        ...
        <div className="row d-flex align-items-center mb-3 aos animated aos-init aos-animate" data-aos="fade-up"
          ...
          <div className="col-lg-8 pt-2 pb-5 d-grid info-mark">
            ...
            <div className="brand">
              ...
              <small className="text-muted">Reviews <strong>20</strong> • Mean</small>
          ...
          <div className="col-lg-4">
            <div className="link-brand">
              <a href={website} className="link">
                <p className="lead p-3 pe-5 rounded-4"><i className="flaticon-global-network me-1"></i> {website}
                  <span>Visit the website</span><i className="flaticon-fleche-angulaire-pointant-vers-la-droite"></i>
                </p>
              </a>
            </div>
          </div>
