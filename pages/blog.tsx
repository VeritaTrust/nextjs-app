...
const Blog: NextPage<Props> = ({productName, organicProductReviews}) => {
            ...
            <div className="container">
              <div className="row">
                <div className="col-11 col-md-12 col-lg-8 py-4 mx-auto">
                  <SearchProduct product_name="dell-universal-dock-d6000s" reviewNb="3" type={'TYPE??TODO:brk'}/>
                  <SearchProduct product_name="dell-npos-auto-sn-esg-5y-keep-your-hd-for-enterprise" reviewNb="6"
                                 type={'TYPE??TODO:brk'}/>
                  <SearchProduct product_name="startech-io-networking-4port-usb-2.0-hub-portable" reviewNb="6"
                                 type={'TYPE??TODO:brk'}/>
                ...
                <div className="col-12 py-4 mx-auto">
                  <div className="row">
                    <div className="dashboard col-12 col-lg-9">
                      <div className="mb-4 bg-white shadow rounded-5 p-4 aos animated aos-init aos-animate"
